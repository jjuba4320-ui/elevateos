...
/* ─── Router shim (no react-router needed) ─── */
function useRoute() {
...
/* ─── App placeholder (would be the real app) ─── */
function AppPage({ navigate }) {
  return (
    <div style={{
      minHeight: "100vh", background: C.surface0,
      display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
      color: C.textPrimary, fontFamily: "system-ui, sans-serif", textAlign: "center", padding: 32
    }}>
      <div style={{
      ...
      <p style={{ color: C.textSecondary, marginBottom: 32, fontSize: 18 }}>
        🚀 واجهة التطبيق ستظهر هنا
      </p>
      <p style={{ color: C.textMuted, maxWidth: 400, marginBottom: 32, lineHeight: 1.7 }}>
        هذا هو المسار <code style={{ background: C.surface2, padding: "2px 8px", borderRadius: 6, color: C.indigoLight }}>/app</code> المخصص لواجهة التطبيق الفعلية.
        يمكن دمج كودك الحالي هنا.
      </p>
...
export default function App() {
  ...
  if (path === "/app") return <AppPage navigate={navigate} />;
